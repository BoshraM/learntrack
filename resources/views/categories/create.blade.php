                ...
                <form method="POST" action="{{ route('categories.store') }}" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="{{ route('categories.index') }}"
                           class="w-full sm:w-auto px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                                  text-center hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                            Back
                        </a>
